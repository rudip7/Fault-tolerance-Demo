                ...
                <div class="contentStyle" id="contentInformation">
                    ...
                    <div id="replicaContent">
                        <div style="font-size: 17px;">
                            <h2 style=" display: inline;">Replica Recovery Demonstration</h2><button class="btn btn-default" onclick="goToReplicaRecovery();" style="float: right; background-color: #58FA82;">Reset</button></div>
                        <br/>
                        <div style="font-size: 17px;">
...
</select>&nbsp;&nbsp;&nbsp; Number of iterations: <input type="text" class="btn btn-default" name="NumberIterations" size="3" <?php echo 'value="'.htmlspecialchars($_GET[ "NumberIterations"]). '"'; ?> id="nIterations" disabled>&nbsp;&nbsp;&nbsp; Failed iteration: <input type="text" class="btn btn-default" name="FailedIteration" size="3" <?php echo 'value="'.htmlspecialchars($_GET[ "FailedIteration"]). '"'; ?> id="failedIteration" disabled>&nbsp;&nbsp;&nbsp;
