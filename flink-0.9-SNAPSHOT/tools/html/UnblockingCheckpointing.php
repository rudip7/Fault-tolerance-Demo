      ...
      <div id="content">
        ...
        <div class="contentStyle" id="contentInformation">
          ...
          <div id="checkpointContent">
           <div style="font-size: 17px;"><h2>Unblocking Checkpointing Demonstration<button class="btn btn-default" onclick="window.location.href='../html/UnblockingCheckpointing.html'" style="float: right; background-color: #58FA82;">Reset</button></h2><br/></div>
    ...
    <?php 
      if($_GET["algorithm"] == "pageRank"){
        ...
        if($_GET["checkpointing"] == "NoCheckpointing"){
            exec('../../bin/flink info -v -c eu.stratosphere.procrustes.experiments.recovery.PageRank /home/rudi/Fault-tolerance-Demo/procrustes-flink-1.0-SNAPSHOT.jar hdfs://localhost:9000/11 hdfs://localhost:9000/outputNew11 325557 10 0 > ../../tools/executionPlan.txt
');

        } else if($_GET["checkpointing"] == "TailCheckpointing"){
            exec('../../bin/flink info -v -c eu.stratosphere.procrustes.experiments.recovery.PageRankLateCpt /home/rudi/Fault-tolerance-Demo/procrustes-flink-1.0-SNAPSHOT.jar hdfs://localhost:9000/11 hdfs://localhost:9000/outputNew11 325557 10 5 > ../../tools/executionPlan.txt
');


        } else if($_GET["checkpointing"] == "HeadCheckpointing"){
            exec('../../bin/flink info -v -c eu.stratosphere.procrustes.experiments.recovery.PageRank /home/rudi/Fault-tolerance-Demo/procrustes-flink-1.0-SNAPSHOT.jar hdfs://localhost:9000/11 hdfs://localhost:9000/outputNew11 325557 10 5 > ../../tools/executionPlan.txt
');
        ...
        if($_GET["checkpointing"] == "NoCheckpointing"){
            exec('../../bin/flink info -v -c eu.stratosphere.procrustes.experiments.recovery.ConnectedComponentsBulk /home/rudi/Fault-tolerance-Demo/procrustes-flink-1.0-SNAPSHOT.jar hdfs://localhost:9000/11 hdfs://localhost:9000/outputNew11 10 0 > ../../tools/executionPlan.txt
');

        } else if($_GET["checkpointing"] == "TailCheckpointing"){
            exec('../../bin/flink info -v -c eu.stratosphere.procrustes.experiments.recovery.ConnectedComponentsBulkLateCpt /home/rudi/Fault-tolerance-Demo/procrustes-flink-1.0-SNAPSHOT.jar hdfs://localhost:9000/11 hdfs://localhost:9000/outputNew11 10 5 > ../../tools/executionPlan.txt
');


        } else if($_GET["checkpointing"] == "HeadCheckpointing"){
            exec('../../bin/flink info -v -c eu.stratosphere.procrustes.experiments.recovery.ConnectedComponentsBulk /home/rudi/Fault-tolerance-Demo/procrustes-flink-1.0-SNAPSHOT.jar hdfs://localhost:9000/11 hdfs://localhost:9000/outputNew11 10 5 > ../../tools/executionPlan.txt
');
...
function renderExecutionPlan () {
  ...
  xhttp.onreadystatechange = function () {
    ...
    /*var planData = this.responseText;
